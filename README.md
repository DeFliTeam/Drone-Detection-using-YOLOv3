...
- Download an image of a dog to test object detection.
  ...
  > ```
- Download pretrained weights for backend from [here.](https://pjreddie.com/media/files/yolov3.weights) This weight must be put in the root folder of the repository. 

## Dataset
YOLOv3 training requires images with .xml files in PASCAL-VOC format.

Click [here.](https://universe.roboflow.com/drones-detection-nyysg/drones-detection-hz6ui/dataset/1/download/voc) to Download Drone Dataset with .xml files in PASCAL-VOC format.
